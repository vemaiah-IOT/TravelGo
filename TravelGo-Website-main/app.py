...
# Insert booking route after dashboard route

# ...existing code...

# Place this after the dashboard route


# ...existing code...

# Move booking route after app is defined
...
# Removed misplaced booking route definition at the top of the file.
